...
const Footer = () => {
  ...
  <footer className="px-4 divide-y bg-gray-900 text-white">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				...
				<span className="self-center text-2xl font-semibold">APP Store</span>
			</a>
		</div>
    ...
    <p>Copyright © {new Date().getFullYear()} - All right reserved by <span className=''> App Store</span> Industries Ltd</p>
  </aside></div>
</footer>
        </div>
    );
